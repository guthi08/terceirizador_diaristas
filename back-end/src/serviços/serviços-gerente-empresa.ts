...
export default class ServiçosGerenteEmpresa {
  ...
  static async buscarGerenteEmpresa(request, response) {
    try {
      ...
      return response.json({
        nome: gerente_empresa.usuário.nome, email: gerente_empresa.usuário.email,
  ...
  static async atualizarGerenteEmpresa(request, response) {
    try {
      ...
      await GerenteEmpresa.update({ usuário: { cpf: cpf_encriptado } }, // aqui eu mudei de Professor para GerenteEmpresa
