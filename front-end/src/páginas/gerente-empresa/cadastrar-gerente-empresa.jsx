...
export default function CadastrarGerenteEmpresa() {
    ...
    function títuloFormulário() {
        if (usuárioLogado?.cadastrado) return "Consultar Gerente da Empresa";
        else return "Cadastrar Gerente Empresa";
    };
    ...
    async function cadastrarGerenteEmpresa() {
        if (validarCampos()) {
            try {
                const response = await serviçoCadastrarGerenteEmpresa({...dados,
            ...
            <Card title={títuloFormulário()} className={estilizarCard(usuárioLogado.cor_tema)}>
                ...
                <div className={estilizarDivCampo()}>
                    ...
                    <InputNumber
                        ...
                        mode="decimal"
                        inputClassName={estilizarInputNumber(erros.anos_experiência_empresarial, usuárioLogado.cor_tema)}
                    />
